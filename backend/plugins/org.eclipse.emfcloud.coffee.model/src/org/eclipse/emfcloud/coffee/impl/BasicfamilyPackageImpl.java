...
import org.eclipse.emfcloud.coffee.BasicfamilyFactory;
...
public class BasicfamilyPackageImpl extends EPackageImpl implements BasicfamilyPackage {
    ...
    *
    * <p>
    * This method is used to initialize {@link BasicfamilyPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public EClass getIdentifiable() { return identifiableEClass; }
    ...
    * @generated
    */
   public EAttribute getIdentifiable_Id() { return (EAttribute) identifiableEClass.getEStructuralFeatures().get(0); }
    ...
    * @generated
    */
   public EClass getPerson() { return personEClass; }
    ...
    * @generated
    */
   public EAttribute getPerson_Name() { return (EAttribute) personEClass.getEStructuralFeatures().get(0); }
    ...
    * @generated
    */
   public EReference getPerson_Children() { return (EReference) personEClass.getEStructuralFeatures().get(1); }
    ...
    * @generated
    */
   public EReference getPerson_Parents() { return (EReference) personEClass.getEStructuralFeatures().get(2); }
    ...
    * @generated
    */
   public EReference getPerson_Mother() { return (EReference) personEClass.getEStructuralFeatures().get(3); }
    ...
    * @generated
    */
   public EReference getPerson_Father() { return (EReference) personEClass.getEStructuralFeatures().get(4); }
    ...
    * @generated
    */
   public EClass getFamily() { return familyEClass; }
    ...
    * @generated
    */
   public EAttribute getFamily_Name() { return (EAttribute) familyEClass.getEStructuralFeatures().get(0); }
    ...
    * @generated
    */
   public EReference getFamily_Members() { return (EReference) familyEClass.getEStructuralFeatures().get(1); }
    ...
    * @generated
    */
   public EClass getMan() { return manEClass; }
    ...
    * @generated
    */
   public EClass getWoman() { return womanEClass; }
    ...
    * @generated
    */
   public BasicfamilyFactory getBasicfamilyFactory() { return (BasicfamilyFactory) getEFactoryInstance(); }
   ...
   public void initializePackageContents() {
      ...
      familyEClass.getESuperTypes().add(this.getIdentifiable());
      ...
      initEReference(getPerson_Children(), this.getPerson(), this.getPerson_Parents(), "children", null, 0, -1,
         Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
