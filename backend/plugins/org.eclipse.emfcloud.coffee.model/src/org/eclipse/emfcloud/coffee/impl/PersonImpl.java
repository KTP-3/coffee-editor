 ...
 * @generated
 */
public abstract class PersonImpl extends IdentifiableImpl implements Person {
   /**
   ...
   public Woman getMother() {
      if (mother != null && mother.eIsProxy()) {
         ...
         if (mother != oldMother) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicfamilyPackage.PERSON__MOTHER, oldMother,
                  mother));
            }
         }
      }
    ...
    * @generated
    */
   public void setMother(final Woman newMother) {
   ...
   public Man getFather() {
      if (father != null && father.eIsProxy()) {
         ...
         if (father != oldFather) {
            if (eNotificationRequired()) {
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicfamilyPackage.PERSON__FATHER, oldFather,
                  father));
            }
         }
      }
    ...
    * @generated
    */
   public void setFather(final Man newFather) {
