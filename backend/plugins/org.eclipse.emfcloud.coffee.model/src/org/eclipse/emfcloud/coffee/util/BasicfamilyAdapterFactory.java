...
public class BasicfamilyAdapterFactory extends AdapterFactoryImpl {
    ...
    * @generated
    */
   protected BasicfamilySwitch<Adapter> modelSwitch = new BasicfamilySwitch<>() {
      @Override
      public Adapter caseIdentifiable(final Identifiable object) {
         return createIdentifiableAdapter();
      }

      @Override
      public Adapter casePerson(final Person object) {
         return createPersonAdapter();
      }

      @Override
      public Adapter caseFamily(final Family object) {
         return createFamilyAdapter();
      }

      @Override
      public Adapter caseMan(final Man object) {
         return createManAdapter();
      }

      @Override
      public Adapter caseWoman(final Woman object) {
   ...
   /**
    * Creates a new adapter for an object of class '{@link basicfamily.Identifiable <em>Identifiable</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link basicfamily.Person <em>Person</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link basicfamily.Family <em>Family</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link basicfamily.Man <em>Man</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link basicfamily.Woman <em>Woman</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
