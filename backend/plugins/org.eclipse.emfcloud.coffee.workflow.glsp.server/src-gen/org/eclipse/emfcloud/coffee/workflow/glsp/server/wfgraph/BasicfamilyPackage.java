...
public interface BasicfamilyPackage extends EPackage {
    ...
    * @generated
    */
   BasicfamilyPackage eINSTANCE = org.eclipse.emfcloud.coffee.workflow.glsp.server.wfgraph.impl.BasicfamilyPackageImpl
      .init();
    ...
    * <!-- end-user-doc -->
    *
    * @see basicfamily.impl.IdentifiableImpl
    * @see basicfamily.impl.BasicfamilyPackageImpl#getIdentifiable()
    * @generated
    */
   int IDENTIFIABLE = 0;
    ...
    * @ordered
    */
   int PERSON__CHILDREN = IDENTIFIABLE_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int PERSON__PARENTS = IDENTIFIABLE_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int PERSON__MOTHER = IDENTIFIABLE_FEATURE_COUNT + 3;
    ...
    * @ordered
    */
   int PERSON__FATHER = IDENTIFIABLE_FEATURE_COUNT + 4;
    ...
    * @ordered
    */
   int PERSON_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 5;
    ...
    * @ordered
    */
   int FAMILY__ID = IDENTIFIABLE__ID;
    ...
    * @ordered
    */
   int FAMILY__NAME = IDENTIFIABLE_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int FAMILY__MEMBERS = IDENTIFIABLE_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int FAMILY_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int FAMILY_OPERATION_COUNT = IDENTIFIABLE_OPERATION_COUNT + 0;
   ...
   /**
    * Returns the meta object for class '{@link basicfamily.Identifiable <em>Identifiable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    *
    * @return the meta object for class '<em>Identifiable</em>'.
    * @see basicfamily.Identifiable
    * @generated
    */
   EClass getIdentifiable();

   /**
    * Returns the meta object for the attribute '{@link basicfamily.Identifiable#getId <em>Id</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    *
    * @return the meta object for the attribute '<em>Id</em>'.
    * @see basicfamily.Identifiable#getId()
    * @see #getIdentifiable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the containment reference list '{@link basicfamily.Family#getMembers
    * <em>Members</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    *
   ...
   interface Literals {
      /**
       * The meta object literal for the '{@link basicfamily.impl.IdentifiableImpl <em>Identifiable</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       *
       * @see basicfamily.impl.IdentifiableImpl
